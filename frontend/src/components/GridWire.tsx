    ...
    <svg className="gridwire" viewBox="0 0 900 700" role="img" aria-label={title}>
      <defs>
        <radialGradient id="fs-grid-glow" cx="50%" cy="35%" r="70%">
          <stop offset="0%" stopColor="var(--grid-glow-0)" />
          <stop offset="55%" stopColor="var(--grid-glow-1)" />
          <stop offset="100%" stopColor="rgba(0, 0, 0, 0)" />
        </radialGradient>
        <linearGradient id="fs-grid-stroke" x1="0" x2="1" y1="0" y2="0">
          <stop offset="0%" stopColor="var(--grid-stroke-0)" />
          <stop offset="45%" stopColor="var(--grid-stroke-1)" />
          <stop offset="100%" stopColor="var(--grid-stroke-0)" />
        </linearGradient>
      ...
      {/* orbit + nodes */}
      <g fill="none" stroke="var(--grid-orbit)" strokeWidth="1">
        <circle cx="450" cy="280" r="120" />
        <circle cx="450" cy="280" r="188" opacity="0.65" />
      </g>
      <g fill="var(--grid-node)">
